...
This chapter treated the `evaluate_fn` as a black box: given a parameter vector, it returns a scalar error and a dictionary of named components. Chapter 19 opens the black box with a complete end-to-end case study in software defect prediction. It walks through every stage of the structural fuzzing campaign on a concrete dataset, demonstrating how the production deployment patterns of this chapter translate into actionable insights about model behavior, fragility, and opportunity. Where this chapter asked "how do we deploy geometric validation?", Chapter 19 asks "what does a complete geometric validation look like in practice?"
